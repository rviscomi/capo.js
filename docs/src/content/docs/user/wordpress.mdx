...
hero:
  actions:
    - text: Install for WordPress
      link: https://wordpress.org/plugins/capo-head-optimizer/
      icon: rocket
      variant: primary
    - text: View on GitHub
...
<Tabs>
  <TabItem label="WordPress admin (recommended)">
    <Steps>
      ...
      2. Search for **Capo - Head Optimizer** (or download `capo.zip` from [GitHub releases](https://github.com/rviscomi/capo-wp/releases) and choose **Upload Plugin**).
      3. Click **Install Now** and then **Activate**.
      4. If you use a page caching plugin (such as WP Super Cache or WP Rocket), flush your cache.
    </Steps>
  </TabItem>
