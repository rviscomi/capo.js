...
By default, capo.js will log validation warnings.
...
Enable the pink theme by setting the `palette` parameter to `"BLUE"`.

## Configuring the extension

:::note
The extension doesn't support custom logging prefixes. Also, only preset color palettes are available.
:::

Open the **Options** page to configure the [extension](/capo.js/user/extension/):

1. Right click on the extension icon <img src="/public/img/capo256.png" style="display: inline; width: 20px; vertical-align: text-bottom; margin: 0;"/>
2. Select **Options**

<picture>
    <source srcset="/img/crx-options-light.png" media="(prefers-color-scheme: dark)"/>
    <img src="/img/crx-options-dark.png"/>
</picture>
