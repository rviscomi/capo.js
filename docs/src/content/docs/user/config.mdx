...
1. Right click on the extension icon <img src="/public/img/capo256.png" style="display: inline; width: 20px; vertical-align: text-bottom; margin: 0;"/>
    ...
    ![The context menu shown after right clicking the extension icon](/public/img/crx-menu.png)
...
![The custom color palette in use](/public/img/custom-palette.png)
