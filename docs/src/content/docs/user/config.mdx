...
![Validation example](/capo.js/img/validation-csp.png)
...
1. Right click on the extension icon <img src="/capo.js/img/capo256.png" style="display: inline; width: 20px; vertical-align: text-bottom; margin: 0;"/>

    ![The context menu shown after right clicking the extension icon](/capo.js/img/crx-menu.png)
...
<picture>
    <source srcset="/capo.js/img/crx-options-light.png" media="(prefers-color-scheme: dark)"/>
    <img src="/capo.js/img/crx-options-dark.png"/>
</picture>
...
![The custom color palette in use](/capo.js/img/custom-palette.png)
