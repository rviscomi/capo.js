...
<CapoWidget
  title="Validation Example: Disallowed Element in <head>"
  snippet={`<title>My Page</title>
...
<CapoWidget
  title="Validation Example: Missing <title> Element"
...
<CapoWidget
  title="Validation Example: Multiple <base> Elements"
  snippet={`<title>Multiple Base Tags</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<base href="https://example.com/v1/">
<base href="https://example.com/v2/">`}
/>
...
<CapoWidget
  title="Validation Example: Invalid http-equiv=set-cookie"
  snippet={`<title>Cookie Test</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="set-cookie" content="session=xyz; path=/">`}
/>
...
<CapoWidget
  title="Validation Example: Content Security Policy Meta Tag"
  snippet={`<title>CSP Example</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
...
<CapoWidget
  title="Validation Example: Invalid Origin Trial Token"
  snippet={`<title>Origin Trial Example</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
...
<CapoWidget
  title="Validation Example: Invalid default-style Directive"
  snippet={`<title>Default Style Example</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="default-style" content="missing-theme">`}
/>
...
<CapoWidget
  title="Validation Example: Redundant Character Encoding Declarations"
  snippet={`<meta charset="utf-8">
...
<CapoWidget
  title="Validation Example: Meta Refresh Directive"
  snippet={`<title>Redirect Example</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
...
<CapoWidget
  title="Validation Example: Disabled DNS Prefetching"
  snippet={`<title>DNS Prefetch Example</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
...
<CapoWidget
  title="Validation Example: Invalid Viewport Directive (user-scalable=no)"
  snippet={`<title>Viewport Example</title>
