...
1. Navigate to the Capo extension in your browser's store:
   - **Chrome**: [Chrome Web Store](https://chrome.google.com/webstore/detail/capo-get-your-%3Chead%3E-in-o/ohabpnaccigjhkkebjofhpmebofgpbeb)
   - **Firefox**: [Mozilla Add-ons](https://addons.mozilla.org/en-US/firefox/) *(Link coming soon)*
