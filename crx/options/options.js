...
})({"dEiJT":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "42036d7a98ade5a7";
module.bundle.HMR_BUNDLE_ID = "1e47e0b20c0ae1f3";
"use strict";
...
},{}],"1HCcz":[function(require,module,exports) {
var _optionsJs = require("../lib/options.js");
let options;
async function initOptions() {
    const data = await chrome.storage.sync.get("options");
    options = new (0, _optionsJs.Options)(data.options);
}
function initUI() {
    ...
    Object.entries((0, _optionsJs.Options).Palettes).forEach(([name, value])=>{
...
},{"../lib/options.js":"5kVuK"}],"5kVuK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Options", ()=>Options);
var _colorsJs = require("./colors.js");
class Options {
    constructor({ preferredAssessmentMode = Options.AssessmentMode.STATIC, validation = true, palette = _colorsJs.DEFAULT, loggingPrefix = "Capo: " } = {}){
    ...
    setPreferredAssessmentModeToStatic(prefersStatic) {
        ...
        if (!prefersStatic) mode = Options.AssessmentMode.DYNAMIC;
    ...
    setPalette(palette) {
        if (!this.isValidPalette(palette)) throw new Error(`Invalid option: palette, expected [${Object.keys(_colorsJs.Palettes).join("|")}] or an array of colors, got "${palette}".`);
        if (typeof palette === "string") {
            this.palette = _colorsJs.Palettes[palette];
            return;
        }
    ...
    isValidPalette(palette) {
        if (typeof palette === "string") return Object.keys(_colorsJs.Palettes).includes(palette);
...
},{"./colors.js":"cjFOc","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"cjFOc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "generateSwatches", ()=>generateSwatches);
...
parcelHelpers.export(exports, "getInvalidBackgroundColor", ()=>getInvalidBackgroundColor);
const Hues = {
    PINK: 320,
    BLUE: 200
};
function generateSwatches(hue) {
    return [
        `oklch(5% .1 ${hue})`,
        `oklch(13% .2 ${hue})`,
        `oklch(25% .2 ${hue})`,
...
const PINK = generateSwatches(Hues.PINK);
const BLUE = generateSwatches(Hues.BLUE);
const Palettes = {
    DEFAULT: DEFAULT,
    PINK: PINK,
    BLUE: BLUE
};
function getInvalidBackgroundColor(elementColor) {
...
},{}]},["dEiJT","1HCcz"], "1HCcz", "parcelRequire3a0c")
