...
describe('validation.js', () => {
  ...
  describe('isValidElement', () => {
    ...
    it('should be case insensitive', () => {
      ...
      assert.strictEqual(isValidElement(element), true);
    });
  });
  ...
  describe('hasValidationWarning', () => {
    it('should detect invalid elements', () => {
      ...
      if (divElement) {
        assert.strictEqual(hasValidationWarning(divElement), true);
      }
    });
  ...
  describe('validateContentType', () => {
    it('should warn about duplicate charset declarations', () => {
      ...
      const { warnings = [] } = getCustomValidations(httpEquiv);
  ...
  describe('validateDefaultStyle', () => {
    ...
    it('should warn when no matching alternate stylesheet', () => {
      ...
      const { warnings = [] } = getCustomValidations(meta);
  ...
  describe('invalid elements', () => {
    it('should detect div in head', () => {
      ...
      if (div) {
        assert.strictEqual(isValidElement(div), false);
    ...
    it('should detect span in head', () => {
      ...
      if (span) {
        assert.strictEqual(isValidElement(span), false);
        assert.strictEqual(hasValidationWarning(span), true);
      }
    });
    ...
    it('should detect p in head', () => {
      ...
      if (p) {
        assert.strictEqual(isValidElement(p), false);
        assert.strictEqual(hasValidationWarning(p), true);
      }
    });
  });
});
