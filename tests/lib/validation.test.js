...
describe("validation.js", () => {
  ...
  describe("validateCSP", () => {
    ...
    it("should accept valid CSP directives", () => {
      ...
      const hasDirectiveWarnings = warnings.some(
        (w) => w.includes("report-uri") || w.includes("frame-ancestors") || w.includes("sandbox"),
      );
